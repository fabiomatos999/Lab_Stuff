...
public class Lab07P2Wrapper {
	...
	public static int[] stackSort(int[] array) {
		/*ADD YOUR CODE HERE*/
        SinglyLinkedStack<Integer> tempStack = new SinglyLinkedStack<Integer>();
        SinglyLinkedStack<Integer> originalStack = new SinglyLinkedStack<Integer>();
        ...
        {
            int tempInt = originalStack.pop();
            while(!tempStack.isEmpty() && tempStack.top() > tempInt)
            {
